...
class Usuario extends CI_Model {
	...
	public function __construct($value = null) {
		...
		if ($value != null) {
			...
			if (is_object($value)) {
				...
				$this->repetir_contraseña = isset($value->repetir_contraseña)? $value->repetir_contraseña : null;
			}
		}
	}
	...
	public function validar() {
		...
		if ($this->repetir_contraseña == null) {
			$errores[] = 'El campo repetir contraseña no puede estar vacío';
		}
		if (empty($errores)) {
			return TRUE;
		} else {
	...
	public function registrar() {
		$data = [
			...
			'repetir_contraseña' => $this->repetir_contraseña,
		];
